...
export async function GET() {
  const baseUrl = process.env.NEXT_PUBLIC_SITE_URL || 'https://www.rainbowfriendschapter3.wiki'
  const siteName = process.env.NEXT_PUBLIC_SITE_NAME || 'Rainbow Friends Chapter 3 Wiki'
